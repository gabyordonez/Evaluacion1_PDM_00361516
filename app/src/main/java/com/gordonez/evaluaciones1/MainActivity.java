...
//Crear un for loop, va a recorrer todos los ID, cuando encuentra el ID va a sumarle 1.
        ...
        /*Para programar el boton send tenemos que hacerlo por medio de un intent explicito, porque
        queremos la informacion que se ingrese en los editText.
        */

        /*se debe buscar por medio de ID*/
